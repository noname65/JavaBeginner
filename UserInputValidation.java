...
public class UserInputValidation {
    public static void main(String[] args) {
        ...
        while (e!=0) {
            ...
            if (a==1){
                b=Options("\nWould you like your wings hot, medium, or mild?",new String[]{null,null,"hot","medium","mild"});
            }
            c=Options("\nWould you like coke or pepsi?",new String[]{null,null,"coke","pepsi",null});
            d=Options("\nWould you like your drink small, medium, or large?",new String[]{null,null,"S","M","L"});
            System.out.println("\nYou ordered "+(a==1?new String[]{"hot ","medium ","mild "}[b]:"")+new String[]{"pizza","wings"}[a]+" with a "+new String[]{"small ","medium ","large "}[d]+new String[]{"C.","P."}[c]);
            e=Options("\nIS this correct?",new String[]{null,null,"yes","no",null});
        }
